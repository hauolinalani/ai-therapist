...
const LegalPage = () => (
  <div className="p-10 flex flex-col items-center">
    <a href = "/" ><img src={logo} alt="Malie Logo" className="absolute left-0 top-0 w-14 h-14 md:w-24 md:h-24 m-4" /></a>
    <div>
        <h1 className="text-4xl font-amerigo font-bold mb-6">Privacy Policy & Terms of Service for Malie</h1>
        <p className="mb-4 text-center font-janna">Last updated: March 6th, 2024</p>
    </div>
    ...
    <div className="text-lg space-y-6 flex flex-col xl:w-2/5 items-start">
      ...
      <p className="font-janna">Welcome to Malie, your AI therapist. We are committed to respecting and protecting your privacy. This Privacy Policy outlines how we handle your personal data. By using our services, you are agreeing to the practices described in this policy.</p>
      ...
      <p className="font-janna">Malie is intended to provide guidance rather than factual information. You should not rely solely on the information provided by Malie, but should double-check it and/or consult a professional. Users must be 18 years of age or older to use our services.</p>
